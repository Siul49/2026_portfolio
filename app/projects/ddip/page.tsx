      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-12 text-[var(--color-deep-navy)]">
        ...
        <div className="md:col-span-8">
           ...
           <p className="text-gray-600 mb-6 font-light leading-relaxed">
             최신 <strong>Next.js 15</strong>의 App Router와 <strong>React 19</strong>를 적극적으로 도입하여 성능을 최적화했습니다. 또한 <strong>Tailwind CSS v4</strong>의 새로운 엔진을 활용하여 빌드 속도를 획기적으로 단축했습니다.
           </p>
           <div className="p-6 bg-blue-50 border-l-4 border-[var(--color-serene-blue)] rounded-r-lg">
              <p className="text-sm text-[var(--color-serene-blue)] font-medium italic italic">
