      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-8">
           <div className="bg-gray-50 p-8 rounded-lg border border-[var(--color-grid-line)] mb-8">
              <h4 className="font-mono text-xs text-[var(--color-serene-blue)] mb-4 uppercase tracking-widest">/// AI Pipeline Flow</h4>
              <div className="space-y-6">
                 <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="font-light text-sm mt-1 text-gray-500">사용자가 업로드한 탑승권 이미지를 전처리하여 노이즈를 제거합니다.</p>
                    </div>
                 </div>
                 <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h5 className="font-bold text-[var(--color-serene-blue)]">Multimodal Analysis (Gemini)</h5>
                        <p className="font-light text-sm mt-1 text-gray-500">Gemini Vision API를 통해 핵심 메타데이터를 구조화된 JSON으로 추출합니다.</p>
                    </div>
                 </div>
                 <div className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-gray-300 text-white flex items-center justify-center font-mono text-xs mt-1 shrink-0">3</div>
                    <div>
                        <h5 className="font-bold text-gray-400">Contextual Guide</h5>
                        <p className="font-light text-sm mt-1 text-gray-500">추출된 데이터를 기반으로 시차 적응 및 기내 맞춤 가이드를 생성합니다.</p>
                    </div>
                 </div>
              </div>
           </div>
